...
export const news: NewsItem[] = [
  {
    slug: "2026-07-09-recruit-pause",
    date: "2026.07.09",
    category: "重要",
    title: "メンバー募集を一時休止します（体験参加お申し込み中の方まで）",
    body: "チームの受け入れ体制を整えるため、新規メンバーの募集を当面の間、一時休止いたします。\n**現在すでに体験参加をお申し込みいただいている方まで**は、これまでどおり対応いたしますのでご安心ください。それ以降の新規募集・体験参加の受付は、いったん停止とさせていただきます。\n興味をお寄せいただいた皆さま、ありがとうございます。募集を再開する際は、改めて公式サイト・SNSにてお知らせいたします。",
  },
  {
