  ...
  },
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "月会費500円（2026年8月分より1,000円に改定）と、活動参加ごとのグラウンド代1人400円が基本費用です。2026年5月15日以降の新規入団者は入会費2,000円が必要です。また、安全のため2026年6月15日以降は全メンバーにスポーツ集団保険（年2,000円）への加入が義務となります。ユニフォーム購入の強制や高額な年会費はありません。",
        },
      },
      {
        "@type": "Question",
