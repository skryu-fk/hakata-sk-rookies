  ...
  },
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "月会費500円と、活動に参加するたびにグラウンド代として人数に関わらず1人あたり400円をいただきます。2026年5月15日以降に新しく入団される方には、これらに加えて入会費2,000円をお支払いいただきます（既存メンバーは対象外）。既存メンバーは月額500円プランのほか、運営協力として半年一括3,000円プランを選択することもできます。ユニフォーム購入の強制や高額な年会費はありません。",
        },
      },
      {
        "@type": "Question",
