...
const ACTIVITY = [
  ...
  { label: "費用",       main: "入会費 ¥2,000 + 月額 ¥500（8月〜¥1,000）", sub: "新規入団者は入会費2,000円（5月15日以降）＋スポーツ保険料2,000円／年（6月15日以降全員必須）＋月会費500円（2026年8月分より1,000円に改定）＋活動参加ごとにグラウンド代400円／回。詳細はお知らせをご覧ください。" },
