...
const ACTIVITY = [
  ...
  { label: "費用",       main: "入会費 ¥2,000 + 月額 ¥500", sub: "新規入団者は入会費2,000円（5月15日以降の入団者から適用、既存メンバーは対象外）＋ チーム運営費として月額500円。※活動に参加するたび、参加人数に関わらず1人あたりグラウンド代400円をいただきます。なお、既存メンバーは月額500円プランのほか、運営協力として半年一括3,000円プランも選択可能です。" },
